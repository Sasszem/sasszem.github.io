...
Mivel **a tranzisztor egy háromlábú állat**, logikusan következik hogy ez - levén ennek egy lába sincs - nem tranzisztor. Ez pedig meg is magyarázza hogy miért nem működik az erősítő - csak adja az ég hogy ne legyen más baj is emellett!
